    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed right-2 top-8 z-[1100] w-[330px] origin-top-right rounded-2xl border border-black/10 dark:border-white/15 bg-white/90 dark:bg-[#1e1e26]/95 p-3 text-neutral-900 dark:text-white shadow-2xl backdrop-blur-3xl select-none"
          role="dialog"
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-2">
            {/* Wi-Fi Tile */}
            <div className="flex items-center gap-2.5 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 p-2.5 transition-colors">
              <button
              ...
              <div className="min-w-0 flex-1 text-left leading-tight">
                <p className="text-xs font-semibold text-neutral-900 dark:text-white">Wi-Fi</p>
                <p className="truncate text-[10px] text-neutral-500 dark:text-neutral-400 font-mono">AWS-SBG-5G</p>
              </div>
            </div>
            ...
            <div
              ...
              className="flex items-center gap-2.5 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 p-2.5 transition-colors cursor-pointer hover:bg-black/10 dark:hover:bg-white/10"
              role="button"
              tabIndex={0}
              ...
              <div
                className={`flex size-9 shrink-0 items-center justify-center rounded-full transition-colors shadow-md ${
                  appearance === "dark"
                    ...
                    : "bg-neutral-200 dark:bg-white/15 text-neutral-700 dark:text-neutral-200"
                }`}
              >
            ...
            >
              ...
              <div className="min-w-0 flex-1 text-left leading-tight">
                <p className="text-xs font-semibold text-neutral-900 dark:text-white">Party Mode</p>
                <p className="text-[10px] text-neutral-500 dark:text-neutral-400 font-mono">
            ...
            >
              <div className="flex size-9 shrink-0 items-center justify-center rounded-full bg-neutral-200 dark:bg-white/15 text-neutral-700 dark:text-white shadow-md transition-colors">
                <Layers className="size-4" />
              </div>
              <div className="min-w-0 flex-1 text-left leading-tight">
                <p className="text-xs font-semibold text-neutral-900 dark:text-white">Settings</p>
                <p className="text-[10px] text-neutral-500 dark:text-neutral-400 font-mono">AWS OS</p>
              </div>
            </div>
          </div>

          {/* ── Display Brightness Slider ────────────────────────────────────── */}
          <div className="mt-2.5 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 p-2.5">
            ...
            <div className="flex items-center gap-2">
              <Sun className="size-4 text-amber-500 dark:text-amber-400 shrink-0" />
              <input
                type="range"
                min="0.3"
                max="1"
                ...
                className="h-1.5 w-full cursor-pointer appearance-none rounded-lg bg-black/15 dark:bg-white/20 accent-[#7940ea]"
              />
            </div>
          </div>
            ...
            <div className="flex items-center gap-2">
              ...
              >
                {isAudioMuted || audioVolume === 0 ? (
                  <VolumeX className="size-4 text-red-500 dark:text-red-400" />
                ) : (
          ...
          <div className="mt-2.5 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 p-2.5">
            <div className="flex items-center gap-3">
              <div className="relative size-11 shrink-0 overflow-hidden rounded-lg border border-black/10 dark:border-white/15 bg-black/10 dark:bg-black/40 shadow-inner">
              ...
              <div className="min-w-0 flex-1 leading-tight text-left">
                <p className="truncate text-xs font-semibold text-neutral-900 dark:text-white">{currentTrack.title}</p>
                <p className="truncate text-[11px] text-neutral-500 dark:text-neutral-400">{currentTrack.artist}</p>
              </div>
              <div className="flex items-center gap-1.5">
                ...
                <button
                  ...
                  className="flex size-7 items-center justify-center rounded-full bg-black/5 dark:bg-white/10 hover:bg-black/10 dark:hover:bg-white/20 text-neutral-600 dark:text-neutral-300 hover:text-neutral-900 dark:hover:text-white transition-colors"
          ...
          <div className="mt-2.5 grid grid-cols-2 gap-2">
            <button
              ...
              className="flex items-center justify-center gap-1.5 rounded-xl border border-black/10 dark:border-white/10 bg-black/5 dark:bg-white/5 py-2 px-2.5 text-xs font-semibold text-neutral-700 dark:text-neutral-200 hover:bg-[#7940ea] hover:text-white dark:hover:text-white transition-colors shadow-xs"
            >
